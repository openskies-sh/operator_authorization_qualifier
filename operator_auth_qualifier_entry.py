...
from .utils import OperatorDataFormatTestConfiguration
...
def parseArgs() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Exceute RID_Qualifier for a locale")
...
def main() -> int:
    ...
    config: OperatorDataFormatTestConfiguration = OperatorDataFormatTestConfiguration(
        injection_target=config_json)
